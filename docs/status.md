...
- The deck bundles the 53 public DataLoader PNG figures under
  `apps/story/assets/dataloader/figures`, avoiding authenticated raw GitHub
  access at presentation time.
